      ...
      <header className="py-6 border-b">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="space-x-6">
            <Link to="/studios" className="font-medium text-candy-red">Реп. точки</Link>
            <Link to="/tutors" className="font-medium">Репетиторы</Link>
          </nav>
        </div>
      </header>
      
      <main className="flex-grow container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8">Репетиционные точки</h1>
